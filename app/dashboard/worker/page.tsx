      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-xs font-medium text-blue-700 uppercase tracking-wide mb-1">Average Rating</p>
            <p className="text-2xl font-bold text-blue-600">{stats.averageRating ? stats.averageRating.toFixed(1) : '—'}</p>
